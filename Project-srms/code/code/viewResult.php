...
<span class="labels" style="color:#000;">Name : <?php echo $name;?><br>Roll No.: <?php echo $roll;?><br>Semester : <?php echo $sem;?></span>
...
?>
<table border="1" cellpadding="5" cellspacing="5" class="design">
<tr><td class="labels" style="text-decoration;"><b>Subject<b></td><td class="labels" style="text-decoration"><b>Marks<b></td></tr>
...
<br />
<br />
<a href="index.php" class="link button">EXIT</a>
</div>
</body>
</html>